...
$code = $_POST['codigo'];
$url_codigo = "https://api.dev.redevistorias.com.br/challenge/service/bar/building/".$code;
...
curl_setopt($ch, CURLOPT_URL, $url_codigo);
...
$arr = []; 
$arr['inspection_type'] = $result['inspection']['type'];
$arr['building_type'] = $result['building']['type'];
$arr['area'] = $result['building']['area'];
$arr['furnished'] = $result['building']['furnished'];
$arr['modality'] = $result['inspection']['modality'];
$arr['express'] = $result['inspection']['express'];
